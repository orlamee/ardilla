      ...
      <div className="content py-5 px-5 earning-section step-four">
        ...
        <div className="row justify-content-center earns saving-top">
          <div className="col-md-8 text-center">
            <h3>Set <span style={{color: "#E8356D"}}>Flex</span><br/>amount</h3>
            ...
            <div className="row justify-content-center">
              <div className="col-md-5">
                <form>
                  ...
                  <div className="mb-5">
                    <Link className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6" to="/flex-savings" style={{width: "100%"}}>Next</Link>
                  </div>
                </form>
              </div>
            </div>
