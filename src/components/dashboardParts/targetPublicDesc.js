      ...
      <div className="content py-5 px-5 earning-section">
        ...
        <div className="row justify-content-center earns">
          <div className="col-md-8 text-center">
            <h3>Lorem Ipsum Monterem<br/><span style={{color: "#E8356D"}}>target public?</span></h3>
            <div className="row justify-content-center mt-4">
              <div className="col-md-6">
                <form>
                  <div className="mb-3">
                    <textarea type="textarea" className="form-control target-form" placeholder="Enter Description" required rows="5"></textarea>
                  </div>
                  <div className="mb-3">
...
export default TargetPublicDesc;
