      ...
      <div className="content py-5 px-5 earning-section">
        ...
        <div className="row justify-content-center earns">
          <div className="col-md-8 text-center">
            <h3>Set <span style={{color: "#E8356D"}}>Target</span><br/>amount</h3>
            ...
            <div className="row justify-content-center">
              <div className="col-md-5">
                <form>
                  ...
                  <div className="mb-3">
                    <Link className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6" to="/target-set-save" style={{width: "100%"}}>Next</Link>
                  </div>
                </form>
              </div>
            </div>
