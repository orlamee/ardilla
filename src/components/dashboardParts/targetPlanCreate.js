    ...
    <section className="main-dash">
      ...
      <div className="content py-5 px-5 earning-section">
        <div className="row backto">
          <Link to="/target-plan"><span><i className="bi bi-chevron-left me-3"></i>Back</span></Link>
        </div>
        ...
        <div className="row justify-content-center earns target-m">
          <div className="col-md-8 text-center">
            <h3>Give your <br/><span style={{color: "#E8356D"}}>target</span> a name</h3>
            <p className="my-5">Enter a name you want to give your target plan</p>
            <div className="row justify-content-center">
              <div className="col-md-5">
                <form>
                  <div className="mb-3">
                    <input type="text" className="form-control target-form" placeholder="Enter Name" required/>
                  </div>
                  <div className="mb-3">
                    <Link className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6" to="/target-earn" style={{width: "100%"}}>Next</Link>
                  </div>
                </form>
              </div>
            </div>
