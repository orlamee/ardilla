...
function PaymentSAN() {
    ...
    <section className="main-dash">
      ...
      <div className="content py-5 px-5 profile-main">
        <div className="row">
          <div className="col-md-5 dilla-right">
            ...
            <div className="d-flex flex-row">
              ...
              {/* BANKING */}
              <div className="modal flex-modal fade" id="banking-transfer" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog right-dialog">
                  <div className="modal-content right-content">
                    <div className="modal-header">
                      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              {/* SAVINGS PLAN */}
              <div className="modal flex-modal fade" id="savingsplan-transfer" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog right-dialog">
                  <div className="modal-content right-content">
                    <div className="modal-header">
                      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              {/* DILLA */}
              <div className="modal flex-modal fade" id="dilla-transfer" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog right-dialog">
                  <div className="modal-content right-content">
                    <div className="modal-header">
                      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              {/* SAN */}
              <div className="modal flex-modal fade" id="san-transfer" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog right-dialog">
                  <div className="modal-content right-content">
                    <div className="modal-header">
                      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <div className="col mt-5">
            <div className="san-transaction p-5">
              ...
              <div className="row justify-content-center mt-2 border-bottom py-3">
                ...
                <div className="col-md-2">
                  <button type="button" to="#" className="btn btn-primary dilla-success btn-sm mt-2 px-3" disabled>Successful</button>
                </div>
              </div>
              <div className="row justify-content-center mt-2 border-bottom py-3">
                <div className="col-md-2">
                ...
                <div className="col-md-2">
                  <button type="button" to="#" className="btn btn-primary dilla-failed btn-sm mt-2 px-3" disabled>Failed</button>
                </div>
              </div>
              <div className="row justify-content-center mt-2 border-bottom py-3">
                <div className="col-md-2">
                      ...
                      <div id="" className="row">
                        <ul className="nav nav-pills dilla-link text-center">
                          <li className="ms-3 me-4 payment-pills active">
                            <a  href="#1a" data-toggle="tab">My Account</a>
                          </li>
                          <li className="me-4 payment-pills">
                            <a href="#2a" data-toggle="tab">Other Banks</a>
                          </li>
                        </ul>
                        <div className="tab-content clearfix mt-5">
                          <div className="tab-pane active" id="1a">
                            <div className="row justify-content-center">
                              <div className="col-md-6 text-center">
                                <Link type="button" data-bs-toggle="modal" data-bs-target="#addbank" class="btn btn-primary btn-sm addmoney-btn"><i class="bi bi-plus"></i> Add a bank account</Link>
                              </div>
                              <div className="row mx-3 top-product">
                                <Link data-bs-toggle="modal" data-bs-target="#addbaak" type="button" className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6 mt-5" to="" style={{width: "100%"}}>Continue</Link>
                              </div>
                            </div>
                          </div>
                          <div className="tab-pane" id="2a">
                            <div className="row">
                              <div className="col">
                                <form className="row">
                                  <div classname="">
                                    <input type="number" className="form-control p-form" placeholder="Enter Account Number"/>
                                  </div>
                                  <div className="row mx-3 btn-bottom">
                                    <Link data-bs-toggle="modal" data-bs-target="#auth" type="button" className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6 mt-5" to="" style={{width: "100%"}}>Continue</Link>
                                  </div>
                                </form>
                              </div>
                            </div>
        ...
        {/* Auth Account Number */}
        <div className="modal  fade" id="auth" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog right-dialog">
            <div className="modal-content right-content">
              <div className="modal-header">
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div className="container initiate-modal p-5">
                  ...
                  <form className="mt-5 row mx-4">
                    <div classname="">
                      ...
                      <input type="text" className="form-control p-form" placeholder="" value="0163864843"/>
                    </div>
                    ...
                    <div className="row mx-3 btn-bottom">
                      <Link data-bs-toggle="modal" data-bs-target="#sendtobankacc" type="button" className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6 mt-5" to="" style={{width: "100%"}}>Continue</Link>
                    </div>
                  </form>
                </div>
              </div>
        ...
        <div className="modal flex-modal fade" id="sendtobankacc" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog right-dialog">
            <div className="modal-content right-content">
              <div className="modal-header">
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              <div className="modal-body flex-modal-body">
                <div className="container initiate-modal p-5">
                  ...
                  <div className="row mx-3">
                    <Link data-bs-toggle="modal" data-bs-target="#successmodal" type="button" className="btn btn-outline-primary px-5 py-3 ardilla-btn fs-6 mt-5" to="" style={{width: "100%"}}>Continue</Link>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Success Modal - Bank */}
        <div className="modal flex-modal fade" id="successmodal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog right-dialog">
            <div className="modal-content right-content">
              <div className="modal-header">
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div className="container initiate-modal p-5">
                  ...
                  <div className="row my-5 sent-details">
                    <div className="col text-center">
                      <img src={sent} alt="" className="img-fluid" />
                      <h3 className="mt-4">Money Transferred</h3>
                      <p>You have successfully sent <span style={{color: "#3D0072"}}>NGN50000 to <br/>Olamilekan Akindele!</span></p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-6 mb-2">
                      <button data-bs-toggle="modal" data-bs-target="#beneficiaries" type="button" className="btn btn-primary btn-lg btn-bene" style={{width: "100%"}}><i className="bi bi-people-fill"></i> Add as Beneficiary</button>
                    </div>
                    <div className="col-md-6 mb-2">
                      <button data-bs-toggle="modal" data-bs-target="#" type="button" className="btn btn-primary btn-lg btn-bene" style={{width: "100%"}}><i className="bi bi-receipt"></i> Show Receipt</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Add Beneficiary */}
        <div className="modal flex-modal fade" id="beneficiaries" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog right-dialog">
            <div className="modal-content right-content">
              <div className="modal-header">
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
