        ...
        <div className="row justify-content-center">
          ...
          <div className="row justify-content-center">
            <div className="col-md-4">
              <form className="my-4">
                <div className="mb-3">
                  <input type="number" className="form-control custom-form" placeholder="Create Pin"/>
                </div>
                <div className="mb-3">
                  <input type="number" className="form-control custom-form" placeholder="Confirm Pin"/>
                </div>
