...
import save from "../../img/dilla-pro.svg";
    ...
    <section className="features-product">
      <div className="container">
        ...
        <div className="row top-products">
          <div className="col-md-6" id="style-8">
            <div className="">
              <h3>Save</h3>
            ...
            {/* <div className="scrollbar mt-5">
              <h3>Learn</h3>
              <h6>Financial freedom begins with You and Ardilla</h6>
              <p>Ardila offers wealth-building tips from great financial minds to help you<br/>get to where you need to be.</p>
              <div className="top-products">
                <div className="d-flex flex-row mb-4">
                  <img src={checklist} alt="check" className="img-fluid"/>
                  <h5 className="ms-4 mt-1">Learn to to invest in 2hrs</h5>
                </div>
                <div className="d-flex flex-row mb-4">
                  <img src={checklist} alt="check" className="img-fluid"/>
                ...
                <div className="d-flex flex-row mb-4">
                  <img src={checklist} alt="check" className="img-fluid"/>
                  <h5 className="ms-4 mt-1">Referral benefits</h5>
                </div>
              </div>
            </div> */}
            {/* <div className="scrollbar mt-5">
